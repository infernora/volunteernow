            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link custom-btn custom-border-btn btn" href="" id="navbarLightDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"><?php echo $user_data['name']; ?></a>
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item active" href="org-info.php">Information</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="custom-text-block">
                        ...
                        <p>Address: <?php echo $user_data['address']; ?>

                        <br>Email: <?php echo $user_data['email']; ?>

                        <br>Website: <?php echo $user_data['website']; ?></p>

                        <p>Description: <?php echo $user_data['description']; ?></p>

                        <p>Cause: <?php echo $user_data['cause_one']; ?>

                        <br>Cause: <?php echo $user_data['cause_two']; ?>

                        <br>Cause: <?php echo $user_data['cause_three']; ?></p>

                        <a href="org-editinfo.php" class="custom-btn btn">Edit</a>
                    </div>
