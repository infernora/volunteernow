        ...
        <section class="p-5">
            <div class="border-bottom p-2 bg-light mb-3">
                <div class="row list" style="text-align:center">
                    <form class="filterform" method="post" action="org-eventhis-present.php">
                ...
                <div class="col-md-12">
                    ...
                    <?php
                        ...
                        if(isset($_POST['filter'])){
                            ...
                            $sql2 .= " WHERE (name LIKE '%{$filter}%' OR location LIKE '%{$filter}%' OR skill LIKE '%{$filter}%' OR description LIKE '%{$filter}%'
                                    OR startdate LIKE '%{$filter}%' OR enddate LIKE '%{$filter}%' OR vol_num LIKE '%{$filter}%' or vol_found LIKE '%{$filter}%') AND org_name = '$org_name' AND status = 'open'";
                            $_SESSION['filter'] = $filter;
                        }else{
                            $sql2 .= " WHERE org_name = '$org_name' AND status = 'open'";
                        }
                    ...
                    <div class="d-flex mb-3 pb-3 border-bottom">
                        <div class="ms-3 ms-md-4">
                            ...
                            <h3><?php echo $name; ?></h3>
                            <p class="mb-2 text-dark text-opacity-75">Location: <?php echo $location; ?>
                            <br>Skills needed: <?php echo $skill; ?>
                            <br>Total Number of volunteers needed:<b> <?php echo $vol_num; ?> </b>
                            <br>Number of volunteers found:<b> <?php echo $vol_found; ?> </b>
                            <br>Start Date: <?php echo $start_date; ?>
                            <br>End Date: <?php echo $end_date; ?>
